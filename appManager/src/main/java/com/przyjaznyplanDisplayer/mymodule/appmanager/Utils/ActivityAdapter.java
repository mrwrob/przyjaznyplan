...
public class ActivityAdapter extends ArrayAdapter<Activity> {
    ...
    public ActivityAdapter(Context ctx, int textViewResourceId, int id, List<Activity> objects) {
    ...
    public void changeOrder(int fromPosition,int toPosition){
        Activity a=objects.get(toPosition);
        ...
        if (activity != null) {
            if (label != null){
                ...
                if(activity.getStatus()!=null && activity.getStatus().equals(Activity.ActivityStatus.FINISHED.toString())){
                    ...
                    if(activity.getTypeFlag() != null && activity.getTypeFlag().equals(Activity.TypeFlag.FINISHED_ACTIVITY_GALLERY.toString())){
